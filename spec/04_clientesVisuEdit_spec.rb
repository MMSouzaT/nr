describe "Clientes", :clientesVE do

    it ' Visualizar - Editar' do
        ...
        fill_in 'RazaoSocial', with: ''
        fill_in 'Nome', with: ''
        fill_in 'CNPJ', with: ''
        fill_in 'Endereco', with: ''
        select('Selecione..', from: 'RamoAtividadeId')
        ...
        fill_in 'RazaoSocial', with: '01 - Visualizado e editado pelo Capybara'
        click_button 'Salvar'
        ...
        fill_in 'Nome', with: '01 - Empresa visualizada e editada pelo Capybara'
        click_button 'Salvar'
        expect(erroCNPJ).to have_content 'Campo de preenchimento obrigatório.'
        expect(erroEndereco).to have_content 'Campo de preenchimento obrigatório.'
        expect(erroRamoAtividade).to have_content 'Campo de preenchimento obrigatório.'
       
        fill_in 'CNPJ', with: '41.208.537/0001-29'
        click_button 'Salvar'
        expect(erroEndereco).to have_content 'Campo de preenchimento obrigatório.'
        expect(erroRamoAtividade).to have_content 'Campo de preenchimento obrigatório.'
